...
<Image 
    ...
    <div className="container justify-between w-full flex flex-row items-center bg-blue-600 h-20 ">
...
<main>
    <section className=" bg-black flex justify-center gap-5 h-auto w-full p-4 mt-8">
        <div className="h-80 w-[450px] bg-blue-800 rounded-md shadow-2xl"></div>
        <div className="h-80 w-[450px] bg-blue-800 rounded-md shadow-2xl"></div>
        <div className="h-80 w-[450px] bg-blue-800 rounded-md shadow-2xl"></div>
    </section>
    <section className=" bg-black flex justify-center gap-2 h-auto w-full p-4 mt-8">
        <div className="h-80 w-[450px] bg-blue-800 rounded-md shadow-2xl"></div>
        <div className="h-80 w-[450px] bg-blue-800 rounded-md shadow-2xl"></div>
    </section>
</main>
